...
public class TestSchedCalendar extends TestCase {
	 ...
	 */
	public void test01_SchedCalendar() {
		...
		try {
            for (int i = 0; i < allTasks.size(); i++) {
                System.out.println(cp.getDomain(allTasks.get(i)) + "\t- Size = " + cp.getSize(allTasks.get(i)) + "\t- Length = " + cp.getLength(allTasks.get(i)));
                assertEquals(cp.getLength(allTasks.get(i)), cp.getEnd(allTasks.get(i)) - cp.getStart(allTasks.get(i)));
                assertEquals(cp.getLength(allTasks.get(i)), cp.getLength(allTasks.get(i).getName()));
            }
