...
public class SchedCumul {
	...
	public static void makeHouse(int id, int rd, List<IloIntExpr> ends, List<IloIntervalVar> allTasks)
	        throws IloException {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (cp.solve()) {
				...
				/**
				 * Disabled code block as "getNumberOfSegments(...)" is NOT SUPPORTED on WML for
