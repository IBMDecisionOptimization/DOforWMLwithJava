...
public class FacilityExplanations {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/**
			 * Failures explanation is NOT supported by CPO WML connector. Following code
			 * will raise an exception.
			 */
			/*
			 * cp.clearExplanations(); cp.explainFailure(15); cp.explainFailure(20); int
			 * failureArray[] = {3, 10, 11, 12}; cp.explainFailure(failureArray);
			 * cp.solve();
			 * 
			 * cp.clearExplanations(); cp.explainFailure(1); cp.solve();
			 */
