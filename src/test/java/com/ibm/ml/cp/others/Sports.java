...
public class Sports {
    ...
    public static void main(String[] args) {
        try {   
            ...
            /**
             * IloCP.startNewSearch() and IloCP.next() are NOT supported in the CPO WML connector.
             * Only IloCP.solve() can be used to solve a model (returning a single solution)
             */
//            cp.startNewSearch();
//            while (cp.next()) {
            if (cp.solve()) {
