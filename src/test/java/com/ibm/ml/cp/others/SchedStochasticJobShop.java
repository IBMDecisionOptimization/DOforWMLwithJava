...
public class SchedStochasticJobShop {
	...
	static IloIntExpr MakeScenarioSubmodel(IloCP cp, int nbJobs, int nbMachines, int[][] machines, int[][] durations,
	...
	public static void main(String[] args)  {
		...
		String filename = "cpo/stochastic_jobshop_default.data";
		...
		try {
			...
			for (k = 0; k < nbScenarios; k++) {
				...
				IloIntExpr scenarioMakespan = MakeScenarioSubmodel(cp, nbJobs, nbMachines, machines, durations[k],
				        scenarioSequences);
