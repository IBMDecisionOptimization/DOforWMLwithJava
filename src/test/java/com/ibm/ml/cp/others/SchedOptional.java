...
public class SchedOptional {
	...
	static final String[] workerNames = { "Joe", "Jack", "Jim" };
	...
	static final String[] taskNames = { "masonry", "carpentry", "plumbing", "ceiling", "roofing", "painting", "windows",
	...
	public static void makeHouse(IntervalVarList allTasks, IntervalVarList[] workerTasks, int id, int deadline)
	        throws IloException {
		...
		cp.add(cp.add(cp.equiv(cp.presenceOf(taskMatrix[masonry][joe]), cp.presenceOf(taskMatrix[carpentry][joe]))));
		cp.add(cp.add(cp.equiv(cp.presenceOf(taskMatrix[roofing][jack]), cp.presenceOf(taskMatrix[facade][jack]))));
		cp.add(cp.add(cp.equiv(cp.presenceOf(taskMatrix[carpentry][joe]), cp.presenceOf(taskMatrix[roofing][joe]))));
		cp.add(cp.add(cp.equiv(cp.presenceOf(taskMatrix[garden][jim]), cp.presenceOf(taskMatrix[moving][jim]))));
	}
