...
class CutStock {
   ...
   public static void main( String[] args ) {
      String datafile = "src/resources/cutstock.dat";
      try {
         if (args.length > 0)
            datafile = args[0];
         readData(datafile);
         ...
         IloCplex cutSolver = new CplexWithWML( new MyProdBetaV4Credentials());
         ...
         IloCplex patSolver = new CplexWithWML( new MyProdBetaV4Credentials());
